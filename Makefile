PREFIX=${DEST_DIR}/opt/nm-plugin-sad
...
BIN_DIR=${PREFIX}/bin
CONF_DIR=${PREFIX}/etc
SUB_DIRS=${DEST_DIR}/etc/NetworkManager/dispatcher.d ${PREFIX} ${CONF_DIR} ${BIN_DIR} ${PREFIX}/tmp ${PREFIX}/templates
...
install_bin:
	...
	rm -rf ${DEST_DIR}/etc/NetworkManager/dispatcher.d/zzz_vpn_sad
	ln -s /opt/nm-plugin-sad/bin/vpn_sad ${DEST_DIR}/etc/NetworkManager/dispatcher.d/zzz_vpn_sad
